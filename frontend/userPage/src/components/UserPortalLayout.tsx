...
export function UserPortalLayout({ children }: UserPortalLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Privacy Settings', href: '/portal/privacy', icon: Settings },
    { name: 'Data Management', href: '/portal/data', icon: Download },
  ]
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-lg font-semibold text-gray-900">MnemoPhi</h1>
            <button
